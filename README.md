# Elderfield — v3.17.0 Dawnrest Style-Lab

This is a **bigger visual reset pass** with a cleaner pause panel and manual save from pause.

The goal of v3.17.0 is to stop inching forward and make Elderfield read much more like the direction you actually want: a stronger **A Link to the Past / late-SNES / early-GBA adventure feel** instead of a smooth procedural prototype.
...
- updated build strings/UI text to **v3.17.0 • Dawnrest Style-Lab**
...
- on-screen build badge: `v3.17.0 • Dawnrest Style-Lab`
- debug/build info showing **v3.17.0**
